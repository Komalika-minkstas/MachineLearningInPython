...
def answer_two():
    ...
    return accuracy_score(y_test, clf_predictions), recall_score(y_test, clf_predictions)# Return your answer
answer_two()
...
def answer_three():
    ...
    return accuracy_score(y_test, clf_predictions), recall_score(y_test, clf_predictions), precision_score(y_test, clf_predictions)
answer_three()
...
def answer_five():
    ...
    plt.plot([0,1],[0,1],lw=3,color='navy', linestyle='--')
    plt.axes().set_aspect('equal')
    plt.show()
    # Your code here
